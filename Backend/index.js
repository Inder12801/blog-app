...
import { createBlog, deleteBlog, getBlog, getBlogs, updateBlog } from './controller/blogsController.js'
...
async function main() {
    ...
    await mongoose.connect("mongodb+srv://inder12801:%40Ijs12801@ecoomercecluster.dwilg3x.mongodb.net/BlogsDB");
